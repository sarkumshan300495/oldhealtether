...
class Search_Filter_Result extends StatefulWidget {
  ...
  @override
  State<Search_Filter_Result> createState() => _Search_Filter_ResultState();
}

class _Search_Filter_ResultState extends State<Search_Filter_Result>
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: 12,bottom: 12,left: 26,right: 26),
                    child: Container(
                      width: 335,
                      height: 59,
                  ...
                  SingleChildScrollView(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsets.only( bottom: 5,left: 26,right: 26),
                      child: Row(
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                       padding:EdgeInsets.only( bottom:13,top: 13,left: 0),
                        child: Container(
                             decoration: BoxDecoration (
                        color: Color(0x1903bf9c),
                      ),
                        width: 390*fem,
                      height: 23*fem,
                          child: Center(
                            child: Text(
                              '12 appointments are listed from the selected date range',
                              style: TextStyle(
